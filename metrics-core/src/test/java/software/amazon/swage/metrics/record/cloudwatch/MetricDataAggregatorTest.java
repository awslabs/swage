...
public class MetricDataAggregatorTest {
    ...
    public void single() throws Exception {
        ...
        assertTrue("Flush with no dimensions was non-empty", aggregator.flush().isEmpty());
    }
    ...
    public void non_aggregated() throws Exception {
        ...
        assertEquals("Metric dimensions hs wrong size", names.length, ags.size());
    ...
    public void aggregate() throws Exception {
        ...
        assertEquals("Metric dimensions hs wrong size", 4, ags.size());
        ...
        // Now add more dimensions, but let's just do two this time
        for (int i=0; i<5; i++) {
        ...
        assertEquals("Metric dimensions hs wrong size", 2, ags.size());
        boolean seenA = false;
        boolean seenO = false;
        for (MetricDatum d : ags) {
